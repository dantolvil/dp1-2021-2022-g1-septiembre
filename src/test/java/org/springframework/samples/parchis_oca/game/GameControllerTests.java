...
import org.springframework.samples.parchis_oca.configuration.SecurityConfiguration;
import org.springframework.samples.parchis_oca.game.Game;
import org.springframework.samples.parchis_oca.game.GameController;
import org.springframework.samples.parchis_oca.game.GameService;
...
class GameControllerTests {
	...
	@MockBean
	private GameService petService;
        
        @MockBean
	private PlayerService ownerService;
	...
	void setup() {
		...
		given(this.ownerService.findOwnerById(TEST_OWNER_ID)).willReturn(new Player());
		given(this.petService.findPetById(TEST_PET_ID)).willReturn(new Game());
	}*/
