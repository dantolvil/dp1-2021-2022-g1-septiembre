...
class PlayerServiceTests {                
	...
	void shouldFindOwnersByLastName() {
		Collection<Player> owners = this.ownerService.findOwnerByLastName("Davis");
	...
	void shouldFindSingleOwnerWithPet() {
		Player owner = this.ownerService.findOwnerById(1);
	...
	public void shouldInsertOwner() {
		Collection<Player> owners = this.ownerService.findOwnerByLastName("Schultz");
