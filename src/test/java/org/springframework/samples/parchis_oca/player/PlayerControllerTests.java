...
import org.springframework.samples.parchis_oca.player.PlayerController;
...
class PlayerControllerTests {
	...
	void testProcessFindFormSuccess() throws Exception {
		given(this.clinicService.findOwnerByLastName("")).willReturn(Lists.newArrayList(george, new Player()));
