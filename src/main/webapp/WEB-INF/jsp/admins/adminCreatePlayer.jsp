...
<parchis_oca:layout pageName="adminCreatePlayer">
	<div class="col-md-6 p-3 m-3 border border-secondary w-100 rounded">
		<form:form method="POST" modelAttribute="user" class="form-signin">
			<h2 class="lead">Create an account (Remember that all fields must be filled)</h2>
			<hr>
			<div class="row">
			...
			<div class="row">
				<div class="col-3 text-end">
					<h3 class="text-capitalize">Confirm the password :</h3>
				</div>
				<div class="col">
